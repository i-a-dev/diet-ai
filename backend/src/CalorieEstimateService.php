...
- should_offer_web_search=true の目安（confidence が high でも true）: カップヌードル シーフード、セブンイレブン 鮭おにぎり、ファミチキ、ザバス ミルクプロテイン、ほっともっと のり弁当、マクドナルド ビッグマック、ローソン のり弁当、ナッシュ たらの辛旨チリソース
